...
$com = "Select * from products where pid='".$_GET['pid']."'";
$r = mysqli_query($con,$com);	
	$row=mysqli_fetch_assoc($r);
	?>			<div class="flexslider">
					
					<ul class="slides">
						<li data-thumb="images/d2.jpg">
							<div class="thumb-image"> <img src="images/<?php echo $row['imagename'];?>" data-imagezoom="true" class="img-responsive"> </div>
						</li>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price"><?php echo "$".$row['cost'];?></span> <del>- $900</del></p>
	  ...
	  $q2="Select * from cart where uid='".$_COOKIE['id']."' and pid='".$_GET['pid']."'";
	  $r2=mysqli_query($con,$q2);
	  $rows=mysqli_num_rows($r2);
	  if($rows>0)
	  {
	  ?><div id="<?php echo $row['pid'];?>">
	  ...
	  <input type="button" onclick="addToCart(<?php echo $_GET['pid'];?>)" name="submit" value="Add to cart" class="button" />
	  </div>
	  <?php }?>
