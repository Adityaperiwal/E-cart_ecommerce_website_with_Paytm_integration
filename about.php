			...
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
				 ...
				 <div class="col-md-6 ab_pic_w3ls_text_info">
				    <h5>About E <span> Cart</span> </h5>
					<p>E-cart is an online shopping store with wide range of products, from games to clothing, We have got you covered for all the things you desire.</p>
				</div>
				  <div class="clearfix"></div>
			</div>    
