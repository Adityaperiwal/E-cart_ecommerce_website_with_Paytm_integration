...
<div class="page-head_agile_info_w3l">
	...
	<div class="banner-bootom-w3-agileits">
		...
		<div class="single-pro">
			<div style="text-align:center;"><h2>Our <?php 
				include_once("dbConnection.php");
				$id=$_GET['type'];
				$q1="Select * from products where type=".$id;
				$r1=mysqli_query($con,$q1); 
				
				 if($id==0)echo "Clothing";
				 else if($id==1)echo "Gaming";
				 else if($id==2)echo "Electronics";
				 else if($id==3)echo "Accessories categeory";
				 else if($id==4)echo "Best Deals on different";
				 else if($id==5)echo "Other ";?> Products</h2> </div>
			...
			<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
										...
										<img src="images/<?php echo $row['imagename'];?>" alt="" class="pro-image-back"height="300px" width="100px">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="productdetails.php?pid=<?php echo $row['pid']; ?>" class="link-product-add-cart">Product Details</a>
												</div>
											</div>
									...
									<div class="item-info-product">
										<div style="height:50px;"><h4><a href="productdetails.php?pid=<?php echo $row['pid']; ?>" style="font-size:100%;"><?php echo $row['name'];?></a></h4></div>
										<div class="info-product-price">
											<span class="item_price">Price: $<?php echo $row['cost'];?></span>
											<del>$69.71</del>
										</div>
