	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<div class="col-md-4 header-middle">
			<form action="searchresults.php" method="post">
					<input type="search" style="color:brown;" name="search" placeholder="Search by product name..." required="">
...
<div class="ban-top">
	<div class="container">
		<div class="top_nav_left">
			...
			<?php if(isset($_COOKIE['id'])){?><span><a href="logout.php" style="float:right;padding-top:20px;padding-left:5px;">Logout</a></span>
				<span style="float:right;padding-top:20px;color:white;"><?php echo $_COOKIE['uname'];?></span>
			<?php } else {?><a href="login.php"><span style="float:right;padding-top:20px;color:white;">Login</span></a><?php }?>
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Product <span>Description </span></h3>
			<!--/w3_short-->
	...
	<div class="banner-bootom-w3-agileits">
		...
		<div class="single-pro">
			<div style="text-align:center;"><h2> <?php 
                ...
                $filter=$_POST['filter'];
                if($filter==0)
                $q1="Select * from products where name like '%".$search."%'";
                else{
                    $q1="Select * from products where name like '%".$search."%' and type='".$filter."'";
                }
				$r1=mysqli_query($con,$q1); ?> You searched for "<?php echo $search;?>"</h2> <h2>Your search results</h2></div>
				 <?php while($row=mysqli_fetch_assoc($r1)) { ?>
			<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/<?php echo $row['imagename'];?>" alt="" class="pro-image-front" height="300px" width="100px">
										<img src="images/<?php echo $row['imagename'];?>" alt="" class="pro-image-back"height="300px" width="100px">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Product Details</a>
												</div>
											</div>
									...
									<div class="item-info-product" >
										<h4><a href="single.html"><?php echo $row['name'];?></a></h4>
										<div class="info-product-price">
											<span class="item_price">$<?php echo $row['cost'];?></span>
											<del>$69.71</del>
										</div>
	...
	if(isset($_COOKIE['id'])){																
	  ...
	  <?php }
	} else {?><a href="login.php"><input type="button" name="submit" value="Add to cart" class="button" /></a><?php }?>
