...
<!-- banner -->
	...
	<div class="banner-bootom-w3-agileits">
		...
		<div class="clearfix"></div>
			...
			<div style="padding-left:200px;"><h1 style="padding-left:150px !important;">Your Order Details</h1>
			</br>.. Your Bill 
			...
			{$ctr++;
				$com="Select * from products where pid='".$id."';";
				$res = mysqli_query($con,$com);
				$row=mysqli_fetch_assoc($res);
				$bill=$row['cost']*$value;
				echo "<tr><td style='text-align:center'> ".$ctr." </td>.<td style='text-align:center'> ".$row['name']."</td> <td> Quantity:".$value." </td><td> Cost:".$row['cost']." </td><td> Amount:".$bill." </td> </tr>" ;
				$totalbill+=$bill;
			
			}
			echo "</table><br>Order no: <b>Odr-A12".($totalbill/2).$_COOKIE['id']."</b>";
            echo "<br>Total amount payble: <b>$".$totalbill."</b>";
			?>
...
<input id="ORDER_ID" tabindex="1" maxlength="20" size="20" name="ORDER_ID" autocomplete="off" value="<?php echo "Odr-A123".($totalbill/2).$_COOKIE['id'];?>" readonly>
<input id="CUST_ID" tabindex="2" maxlength="12" size="12" name="CUST_ID" autocomplete="off" value="<?php echo $_COOKIE['id'];?>" readonly>
...
<input title="TXN_AMOUNT" tabindex="10" type="text" name="TXN_AMOUNT" value="<?php echo $totalbill;?>">

<div class="info-product-price" style="text-align:center;padding-bottom:20px;"><input type="submit" style="font-size: 15px;color: #fff;background: #2fdab8;text-decoration: none;position: relative;border: none;border-radius: 0;width: 200px;text-transform: uppercase;padding: .5em 0;outline: none;letter-spacing: 1px;font-weight: 600;" value="Pay Now with Paytm" class="button1"></div>

</form>
</div>
	<a href="#"><div class="info-product-price" style="text-align:center;padding-bottom:20px;"><input type="Button" style="font-size: 15px;color: #fff;background: #2fdab8;text-decoration: none;position: relative;border: none;border-radius: 0;width: 200px;text-transform: uppercase;padding: .5em 0;outline: none;letter-spacing: 1px;font-weight: 600;" value="Cash on Delivery" class="button1"></div>
</a>
</div>
