...
<!-- banner -->
	...
	<div class="banner-bootom-w3-agileits">
        ...
        $com ="Select * from users where uid='".$_COOKIE['id']."'";
...
<table>
<tr><td>Change Name</td><td><input type=text name="name" value="<?php echo $row['name'];?>"></td><tr>
<tr><td>Change Password</td><td><input type="password" name="pass" value="<?php echo $row['password'];?>"></td><tr>
<tr><td>Choose Profile picture</td><td><input type="file" name="profilepic" value="Choose profile picture"></td><tr>

</table>
							
	<div class="info-product-price" style="text-align:center;padding-bottom:20px;"><input type="submit" style="font-size: 15px;color: #fff;background: #2fdab8;text-decoration: none;position: relative;border: none;border-radius: 0;width: 200px;text-transform: uppercase;padding: .5em 0;outline: none;letter-spacing: 1px;font-weight: 600;" value="Update profile" class="button1"></div>
