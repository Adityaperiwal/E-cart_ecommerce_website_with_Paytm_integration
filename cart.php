...
<!-- banner -->
	...
	<div class="banner-bootom-w3-agileits">
		...
		<div class="single-pro">
			<div style="text-align:center;"><h2>Your cart </h2><form action="placeorder.php" method="POST">
			<?php 
			...
			<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										...
										<img src="images/<?php echo $row2['imagename'];?>" alt="" class="pro-image-back"height="300px" width="100px">
	...
	<div class="info-product-price" style="text-align:center;padding-bottom:20px;"><input type="submit" style="font-size: 15px;color: #fff;background: #2fdab8;text-decoration: none;position: relative;border: none;border-radius: 0;width: 200px;text-transform: uppercase;padding: .5em 0;outline: none;letter-spacing: 1px;font-weight: 600;" value="Order Now" class="button1"></div>
